...
#-----------------------------------------------------------------
# def seq_init 
def tr_seq_init(mylist):

  myseq = Sequence('s001')
  myseq.img = 'images/start.jpg'
  myseq.msg += "You are an intrepid explorer. Your goal is to reach the lost treasure that lies within the sacred temple. But it will not be easy."
  myseq.msg += "Do you wish to begin? y/n"
  myseq.next = {'y':'s002','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Do you wish to go left, right or straight? l/r/s."
  myseq.next = {'l':'s100','r':'s200','s':'s300'} 
  mylist.append(myseq)

  # Enter the room, there are two doors
  myseq = Sequence('s100')
  myseq.img = 'images/leftandright.jpg'
  myseq.msg += "You go left and enter a room. There are two doors. Which one will you take? l/r."
  myseq.next = {'l':'s101','r':'s120'} 
  mylist.append(myseq)
  ...
  myseq.msg += "It appears to contain a chest. It could be a trap. Do you wish to enter the room and open the chest? y/n."
  myseq.next = {'y':'s102','n':'s150'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Do you wish to play again? (y/n)"
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Do you wish to fight the demon or do you wish to run and escape the temple empty-handed? f/r."
  myseq.next = {'r':'s105','f':'s106'} 
  mylist.append(myseq)
  ...
  myseq.msg += "The ceiling is lined with massive spikes and is slowly descending towards you. You are dead. Game over. Do you wish to restart? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Do you wish to fight the demon or do you wish to run and escape the temple empty-handed? f/r."
  myseq.next = {'f':'s151','r':'s152'} 
  mylist.append(myseq)

  # You fight but die because you don't have a weapon
  myseq = Sequence('s151')
  myseq.msg += "You are unarmed so the demon easily defeats you. You are dead. Do you wish to restart? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq = Sequence('s152')
  myseq.img = 'images/runaway.jpg'
  myseq.msg += "You run away and lose. Do you wish to restart? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
...
#-------------------------------------------------------------
  ...
  myseq.msg += "You turn around to discover that a horde of flesh eating baboons are pursuing you. Do you want to run or fight? r/f."
  myseq.next = {'f':'s201','r':'s202'} 
  mylist.append(myseq)

  # You fight the baboons and die 
  myseq = Sequence('s201')
  myseq.img = 'images/baboonskill.jpg' 
  myseq.msg += "You attempt to fight the horde but you are no match for the baboons. They easily defeat you. You are dead. Do you wish to restart? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Do you want to go left or right? l/r."
  myseq.next = {'r':'s203','l':'s220'} 
  mylist.append(myseq)
  ...
  myseq.msg += "It defeats the horde of baboons and turns to you. It is beckoning you. Do you trust it? It may kill you. y/n."
  myseq.next = {'n':'s204','y':'s205'} 
  mylist.append(myseq)
  ...
  myseq.msg += "You are dead. Do you wish to restart? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq = Sequence('s205')
  myseq.img = 'images/clokedfigure.jpg' 
  myseq.msg += "You approach the dark figure. It is offering you help. Do you accept? y/n."
  myseq.next = {'n':'s206','y':'s207'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Suddenly, a swarm of poisonous hornets fly from the gulch and kill you. You are dead. Do you wish to restart? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "You won but at the cost of a cut of the treasure. Do you wish to play again? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Which button do you push? The left button, the right button or the middle button? l/r/m."
  myseq.next = {'l':'s221','r':'s221','m':'s221'} 
  mylist.append(myseq)
  ...
  myseq.msg += "The horde of baboons enter the room and kill you. You are dead. Do you wish to restart? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "You won. Do you wish to play again? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
...
#-------------------------------------------------------------
  ...
  myseq.msg += "You go straight and reach a room containing an altar. On the altar is a sword. Do you want to take the sword? It could be a trap. y/n."
  myseq.next = {'y':'s301','n':'s350'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Do you want to fight the jaguar or do you want to run and escape the temple empty-handed? f/r."
  myseq.next = {'r':'s304','f':'s305'} 
  mylist.append(myseq)

  # You run from the jaguar and escape empty handed.
  myseq = Sequence('s304')
  myseq.msg += "You run and escape the temple empty-handed. Do you wish to play again? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Despite wielding a sword, you are defeated and devoured by the jaguar. You are dead. Do you wish to play again? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "You open the chest and claim the lost treasure. You won. Do you wish to play again? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq.msg += "Do you want to fight the jaguar, despite having no weapons, or do you want to run and escape the temple empty-handed? f/r."
  myseq.next = {'r':'s351','f':'s352'} 
  mylist.append(myseq)
  ...
  myseq.msg += "You won. Do you want to play again? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
  ...
  myseq = Sequence('s354')
  myseq.img = 'images/dead.jpg' 
  myseq.msg += "As you do not have a weapon, the jaguar easily defeats you. You are dead. Do you wish to play again? y/n."
  myseq.next = {'y':'s001','n':'s000'} 
  mylist.append(myseq)
